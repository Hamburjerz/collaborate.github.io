...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT account_id, user_id, role, pass FROM account_tbl WHERE email = ?";
    ...
    if ($stmt) {
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $storedHashedPassword)) {
                ...
                switch ($role) {
                    case 'student':
                        header("Location: ../collaborate/profile");
                        break;
                    case 'adviser':
                        header("Location: ../collaborate/prof-dashboard/course");
                        break;
                    case 'admin':
...
<body style="color: rgb(20,54,156);">
    <header class="pt-5" style="margin-top: -50px;"></header>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center" id="login-box">
                        <div class="login-box-header"><img src="assets/img/profile.png" style="width: 91px;"></div>
                        <div class="email-login" style="background-color: #ffffff;">
                            <form method="POST" style="border:none">
                                <div id="emailMessage" style="color: red; margin-left: 5px; font-size: small;">
                                    <?php
                                    if (isset($error)) {
                                        echo $error;
                                    } else {
                                ...
                                <input type="text" name="email" class="password-input form-control" style="margin-top: 10px; border-radius: 5px; margin-bottom: 0px; font-family: Alexandria, sans-serif;" placeholder="Email" required oninput="emailReg(event)">
                                <input type="password" name="pass" class="password-input form-control" style="margin-top: 10px; border-radius: 5px; font-family: Alexandria, sans-serif;" placeholder="Password" required oninput="passwReg(event)">
                                <button class="btn btn-primary text-center d-block box-shadow w-100" type="submit" name="login" style="background: rgb(12, 53, 106); margin-right: 2px; margin-left: -2px;">Login</button>
                                <div class="d-flex justify-content-between"><a id="forgot-password-link" href="forgot-pass">Forgot Password?</a></div>
                            </form>
                        </div>
                ...
                <div class="col-md-6 offset-xl-0" style="padding-top: 99px;"><img class="img-fluid" src="assets/img/register.png" width="800" height="259"></div>
            </div>
        </div>
